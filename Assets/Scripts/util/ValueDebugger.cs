...
namespace util
{
    public class ValueDebugger : MonoBehaviour
    {
        ...
        static public bool showDebugger = false;
        ...
        public static void ValueLog(string name, object value, bool skipActiveCheck = false, bool SkipLogging = false)
        {
            if (!showDebugger)
                return;
            ...
            if (!skipActiveCheck)
            {
                ...
                else if (!instance.transform.parent.gameObject.activeSelf)
                {
        ...
        Dictionary<string, object> tmpDictonary;
        void Process()
        {
            ts = "";

            tmpDictonary = new Dictionary<string, object>(Values);

            foreach (KeyValuePair<string, object> vs in tmpDictonary)
            {
